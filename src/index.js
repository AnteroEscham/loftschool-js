    ...
    function reqursiveDOM (root) {
        for (const node of root.childNodes) {
            ...
            if (node.nodeType === 1) {
                ...
                if (statObj.tags[node.tagName]) {
                    statObj.tags[node.tagName] += 1;
                    
                } else if (statObj.tags[node.tagName] === undefined) {
                    statObj.tags[node.tagName] = 1;
                }
                
                for (let oneClass of node.classList) {

                    if (statObj.classes[oneClass]) {
                        statObj.classes[oneClass] += 1;

                    } else if (statObj.classes[oneClass] == undefined) {
